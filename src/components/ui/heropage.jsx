"use client"; // Required for useEffect and animations
    ...
    <>
      <style>
        {`
          ...
          .animation-line { fill: none; stroke: white; stroke-width: 2; }
          @keyframes pulse {
      ...
      <div className="min-h-screen flex items-center justify-center bg-black text-white font-sans overflow-hidden relative">
        <div className="container text-center z-10 relative p-10 animate-fadeIn">
          <h1 className="text-6xl leading-tight m-0 relative z-20">
            Ready to build<br />
            <span className="gradient-text inline-block relative z-10 font-serif">the workflow of your dreams?</span>
          </h1>
        </div>
        ...
        <div className="pattern absolute w-[200%] h-[200%] bg-[repeating-linear-gradient(45deg,transparent,transparent_10px,rgba(255,255,255,0.1)_10px,rgba(255,255,255,0.1)_20px)] animate-patternScroll opacity-30" style={{ top: '-50%', left: '-50%' }}></div>
      </div>
    </>
  );
};
